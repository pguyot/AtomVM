...
- `jit_armv6m` for ARMv6-M (AArch32 Thumb mode) ABI, with an ARMv7-M variant using Thumb-2 32-bit encodings for Cortex-M3+ targets (Raspberry Pi Pico 2, STM32 with Cortex-M3/M4/M7/M33)
