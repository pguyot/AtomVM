...
struct ModuleNativeInterface
{
    ...
    int (*bitstring_utf8_size)(int64_t c);
    int (*bitstring_utf16_size)(int64_t c);
    term (*term_create_empty_binary)(Context *ctx, size_t len);
    int (*decode_flags_list)(Context *ctx, JITState *jit_state, term l);
    int (*bitstring_insert_utf8)(term bin, size_t offset, int64_t c);
    int (*bitstring_insert_utf16)(term bin, size_t offset, int64_t c, enum BitstringFlags flags);
    bool (*bitstring_insert_utf32)(term bin, size_t offset, int64_t c, enum BitstringFlags flags);
