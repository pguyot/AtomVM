...
_Static_assert(offsetof(Context, e) == 0x14, "ctx->e is 0x14 in jit/src/jit_xtensa.erl");
_Static_assert(offsetof(Context, x) == 0x18, "ctx->x is 0x18 in jit/src/jit_xtensa.erl");
_Static_assert(offsetof(Context, cp) == 0x5C, "ctx->cp is 0x5C in jit/src/jit_xtensa.erl");
_Static_assert(offsetof(Context, fr) == 0x60, "ctx->fr is 0x60 in jit/src/jit_xtensa.erl");
_Static_assert(offsetof(Context, bs) == 0x64, "ctx->bs is 0x64 in jit/src/jit_xtensa.erl");
_Static_assert(offsetof(Context, bs_offset) == 0x68, "ctx->bs_offset is 0x68 in jit/src/jit_xtensa.erl");
