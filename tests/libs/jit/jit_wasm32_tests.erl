...
set_bs_test() ->
    ...
    Dump = <<
        ...
        " 0000bc:	20 00                     	local.get 0\n"
        " 0000be:	20 03                     	local.get 3\n"
        " 0000c0:	36 02 7c                  	i32.store 2 124\n"
        " 0000c3:	20 00                     	local.get 0\n"
        " 0000c5:	41 00                     	i32.const 0\n"
        " 0000c7:	36 02 80 01               	i32.store 2 128\n"
        " 0000cb:	20 00                     	local.get 0\n"
        " 0000cd:	0f                        	return\n"
        " 0000ce:	0b                        	end\n"
...
call_or_schedule_next_test() ->
    ...
    Dump = <<
        ...
        " 0000d3:	36 02 70                  	i32.store 2 112\n"
        " 0000d6:	20 00                     	local.get 0\n"
        " 0000d8:	20 03                     	local.get 3\n"
        " 0000da:	36 02 74                  	i32.store 2 116\n"
        ...
        " 000103:	11 01 00                  	  call_indirect 0 <env.__indirect_function_table> (type 1)\n"
        " 000106:	0f                        	  return\n"
        " 000107:	0b                        	end\n"
...
move_to_cp_test() ->
    ...
    Dump = <<
        ...
        " 0000d5:	36 02 74                  	i32.store 2 116\n"
...
call_primitive_with_cp_test() ->
    ...
    Dump = <<
        ...
        " 0000c6:	36 02 70                  	i32.store 2 112\n"
        " 0000c9:	20 00                     	local.get 0\n"
        " 0000cb:	20 03                     	local.get 3\n"
        " 0000cd:	36 02 74                  	i32.store 2 116\n"
        " 0000d0:	20 00                     	local.get 0\n"
        " 0000d2:	20 01                     	local.get 1\n"
        " 0000d4:	20 02                     	local.get 2\n"
        " 0000d6:	28 02 00                  	i32.load 2 0\n"
        " 0000d9:	11 01 00                  	call_indirect 0 <env.__indirect_function_table> (type 1)\n"
        " 0000dc:	0f                        	return\n"
        " 0000dd:	20 00                     	local.get 0\n"
        " 0000df:	0f                        	return\n"
        " 0000e0:	0b                        	end\n"
