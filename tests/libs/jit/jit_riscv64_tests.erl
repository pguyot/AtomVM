...
call_ext_with_cp_direct_test() ->
    ...
    Dump =
        <<"   0:	00093f03          	ld	t5,0(s2)\n   4:	000f2f03          	lw	t5,0(t5)\n   8:	0f62                	slli	t5,t5,0x18\n   a:	22800f93          	li	t6,552\n   e:	00000013          	nop\n  12:	01ff6f33          	or	t5,t5,t6\n  16:	0fe4b023          	sd	t5,224(s1)\n  1a:	00093f83          	ld	t6,0(s2)\n  1e:	090fbf83          	ld	t6,144(t6)\n  22:	018fbf03          	ld	t5,24(t6)\n  26:	000f2e83          	lw	t4,0(t5)\n  2a:	ff9e8e13          	addi	t3,t4,-7\n  2e:	000e1e63          	bnez	t3,0x4a\n  32:	000efe93          	andi	t4,t4,0\n  36:	9f76                	add	t5,t5,t4\n  38:	01d93423          	sd	t4,8(s2)\n  3c:	008f3e83          	ld	t4,8(t5)\n  40:	010f3f03          	ld	t5,16(t5)\n  44:	01d93023          	sd	t4,0(s2)\n  48:	8f02                	jr	t5\n  4a:	03800f93          	li	t6,56\n  4e:	9fce                	add	t6,t6,s3\n  50:	000fbf83          	ld	t6,0(t6)\n  54:	1141                	addi	sp,sp,-16\n  56:	e006                	sd	ra,0(sp)\n  58:	4501                	li	a0,0\n  5a:	4585                	li	a1,1\n  5c:	460d                	li	a2,3\n  5e:	56f9                	li	a3,-2\n  60:	0544b823          	sd	s4,80(s1)\n  64:	9f82                	jalr	t6\n  66:	8faa                	mv	t6,a0\n  68:	6082                	ld	ra,0(sp)\n  6a:	0141                	addi	sp,sp,16\n  6c:	001fff13          	andi	t5,t6,1\n  70:	000f1463          	bnez	t5,0x78\n  74:	857e                	mv	a0,t6\n  76:	8082                	ret\n  78:	0504ba03          	ld	s4,80(s1)\n  7c:	ffdf8f13          	addi	t5,t6,-3\n  80:	000f0563          	beqz	t5,0x8a\n  84:	ffefff93          	andi	t6,t6,-2\n  88:	8f82                	jr	t6">>,
    ?assertStream(riscv64, Dump, ?BACKEND:stream(State1)).
...
call_fun_with_cp_direct_test() ->
    ...
    Dump =
        <<"   0:	0584bf83          	ld	t6,88(s1)\n   4:	00093e83          	ld	t4,0(s2)\n   8:	000eae83          	lw	t4,0(t4)\n   c:	0ee2                	slli	t4,t4,0x18\n   e:	15000f13          	li	t5,336\n  12:	00000013          	nop\n  16:	01eeeeb3          	or	t4,t4,t5\n  1a:	0fd4b023          	sd	t4,224(s1)\n  1e:	03800f13          	li	t5,56\n  22:	9f4e                	add	t5,t5,s3\n  24:	000f3f03          	ld	t5,0(t5)\n  28:	1141                	addi	sp,sp,-16\n  2a:	e006                	sd	ra,0(sp)\n  2c:	4501                	li	a0,0\n  2e:	85fe                	mv	a1,t6\n  30:	4605                	li	a2,1\n  32:	0544b823          	sd	s4,80(s1)\n  36:	9f02                	jalr	t5\n  38:	8f2a                	mv	t5,a0\n  3a:	6082                	ld	ra,0(sp)\n  3c:	0141                	addi	sp,sp,16\n  3e:	001f7f93          	andi	t6,t5,1\n  42:	000f9463          	bnez	t6,0x4a\n  46:	857a                	mv	a0,t5\n  48:	8082                	ret\n  4a:	0504ba03          	ld	s4,80(s1)\n  4e:	ffef7f13          	andi	t5,t5,-2\n  52:	8f02                	jr	t5">>,
    ?assertStream(riscv64, Dump, ?BACKEND:stream(State2)).
...
get_list_head_tail_test() ->
    ...
    Dump = <<
        "   0:\t0584bf83          \tld\tt6,88(s1)\n"
        "   4:\t008fbf03          \tld\tt5,8(t6)\n"
        "   8:\t000fbe83          \tld\tt4,0(t6)\n"
        "   c:\t07e4b023          \tsd\tt5,96(s1)\n"
        "  10:\t07d4b423          \tsd\tt4,104(s1)"
    >>,
    ?assertStream(riscv64, Dump, ?BACKEND:stream(State2)),
...
read_shrink_probe_mismatch_test() ->
    ...
    Dump = <<
        "   0:\t0084bf83          \tld\tt6,8(s1)\n"
        "   4:\t000fbf83          \tld\tt6,0(t6)\n"
        "   8:\t0204bf03          \tld\tt5,32(s1)\n"
        "   c:\t1a04be83          \tld\tt4,416(s1)\n"
