...
decrement_reductions_test() ->
    ...
    Dump =
        <<
            ...
            "  18:	e59a6008 	ldr	r6, [sl, #8]\n"
            "  1c:	e2566001 	subs	r6, r6, #1\n"
            "  20:	e58a6008 	str	r6, [sl, #8]\n"
            "  24:	1a000004 	bne	0x3c\n"
            "  28:	e28f600c 	add	r6, pc, #12\n"
            "  2c:	e58a6004 	str	r6, [sl, #4]\n"
...
call_ext_only_test() ->
    ...
    Dump =
        <<
            "   0:	e59a6008 	ldr	r6, [sl, #8]\n"
            "   4:	e2566001 	subs	r6, r6, #1\n"
            "   8:	e58a6008 	str	r6, [sl, #8]\n"
            "   c:	1a000004 	bne	0x24\n"
            "  10:	e28f600c 	add	r6, pc, #12\n"
            "  14:	e58a6004 	str	r6, [sl, #4]\n"
            "  18:	e5996008 	ldr	r6, [r9, #8]\n"
            "  1c:	e5878028 	str	r8, [r7, #40]	@ 0x28\n"
            "  20:	e12fff16 	bx	r6\n"
            "  24:	e5996010 	ldr	r6, [r9, #16]\n"
            "  28:	e3a00028 	mov	r0, #40	@ 0x28\n"
...
decrement_reductions_invalidates_cache_test() ->
    ...
    Dump = <<
        "   0:	e597602c 	ldr	r6, [r7, #44]	@ 0x2c\n"
        "   4:	e59a6008 	ldr	r6, [sl, #8]\n"
        "   8:	e2566001 	subs	r6, r6, #1\n"
        "   c:	e58a6008 	str	r6, [sl, #8]\n"
...
call_only_or_schedule_next_and_label_relocation_test() ->
    ...
    Dump =
        <<
            ...
            "  1c:	e2566001 	subs	r6, r6, #1\n"
            "  20:	e58a6008 	str	r6, [sl, #8]\n"
            "  24:	1a000007 	bne	0x48\n"
            "  28:	e1a0600f 	mov	r6, pc\n"
            "  2c:	e3e0501f 	mvn	r5, #31\n"
            "  30:	e0855006 	add	r5, r5, r6\n"
            "  34:	e1a0600a 	mov	r6, sl\n"
            "  38:	e5865004 	str	r5, [r6, #4]\n"
            "  3c:	e5996008 	ldr	r6, [r9, #8]\n"
            "  40:	e5878028 	str	r8, [r7, #40]	@ 0x28\n"
            "  44:	e12fff16 	bx	r6\n"
            "  48:	e5996000 	ldr	r6, [r9]\n"
