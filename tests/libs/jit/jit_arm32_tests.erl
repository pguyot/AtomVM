...
call_or_schedule_next_test() ->
    ...
    Dump =
        <<
            ...
            "  28:	e28f6030 	add	r6, pc, #48	@ 0x30\n"
            "  2c:	e320f000 	nop	{0}\n"
            "  30:	e5876070 	str	r6, [r7, #112]	@ 0x70\n"
            "  34:	e25bb001 	subs	fp, fp, #1\n"
            "  38:	1a000008 	bne	0x60\n"
            "  3c:	e1a0600f 	mov	r6, pc\n"
            "  40:	e3e05033 	mvn	r5, #51	@ 0x33\n"
            "  44:	e0855006 	add	r5, r5, r6\n"
            "  48:	e1a0600a 	mov	r6, sl\n"
            "  4c:	e5865004 	str	r5, [r6, #4]\n"
            "  50:	e5996008 	ldr	r6, [r9, #8]\n"
