...
call_only_or_schedule_next_and_label_relocation_test() ->
    ...
    Dump =
        <<
            ...
            "  14:	ea00000a 	b	0x44\n"
            "  18:	e25bb001 	subs	fp, fp, #1\n"
            "  1c:	1a000008 	bne	0x44\n"
            "  20:	e1a0600f 	mov	r6, pc\n"
            "  24:	e3e05017 	mvn	r5, #23\n"
            "  28:	e0855006 	add	r5, r5, r6\n"
            "  2c:	e1a0600a 	mov	r6, sl\n"
            "  30:	e5865004 	str	r5, [r6, #4]\n"
            "  34:	e5996008 	ldr	r6, [r9, #8]\n"
            "  38:	e5878028 	str	r8, [r7, #40]	@ 0x28\n"
            "  3c:	e58ab008 	str	fp, [sl, #8]\n"
            "  40:	e12fff16 	bx	r6\n"
            "  44:	e5996000 	ldr	r6, [r9]\n"
            "  48:	e5878028 	str	r8, [r7, #40]	@ 0x28\n"
            "  4c:	e58ab008 	str	fp, [sl, #8]\n"
            "  50:	e12fff16 	bx	r6\n"
            "  54:	e5996004 	ldr	r6, [r9, #4]\n"
            "  58:	e5878028 	str	r8, [r7, #40]	@ 0x28\n"
            "  5c:	e58ab008 	str	fp, [sl, #8]\n"
            "  60:	e12fff16 	bx	r6"
        >>,
    ?assertStream(arm32, Dump, Stream).
...
call_or_schedule_next_test() ->
    ...
    Dump =
        <<
            ...
            "  18:	e320f000 	nop	{0}\n"
            "  1c:	ea000012 	b	0x6c\n"
            "  20:	e28f0034 	add	r0, pc, #52	@ 0x34\n"
            "  24:	e320f000 	nop	{0}\n"
            "  28:	e59a1000 	ldr	r1, [sl]\n"
            "  2c:	e1c707f0 	strd	r0, [r7, #112]	@ 0x70\n"
            "  30:	e25bb001 	subs	fp, fp, #1\n"
            "  34:	1a000008 	bne	0x5c\n"
            "  38:	e1a0600f 	mov	r6, pc\n"
            "  3c:	e3e0502f 	mvn	r5, #47	@ 0x2f\n"
            "  40:	e0855006 	add	r5, r5, r6\n"
            "  44:	e1a0600a 	mov	r6, sl\n"
            "  48:	e5865004 	str	r5, [r6, #4]\n"
            "  4c:	e5996008 	ldr	r6, [r9, #8]\n"
            "  50:	e5878028 	str	r8, [r7, #40]	@ 0x28\n"
            "  54:	e58ab008 	str	fp, [sl, #8]\n"
            "  58:	e12fff16 	bx	r6\n"
            "  5c:	e5996000 	ldr	r6, [r9]\n"
            "  60:	e5878028 	str	r8, [r7, #40]	@ 0x28\n"
            "  64:	e58ab008 	str	fp, [sl, #8]\n"
            "  68:	e12fff16 	bx	r6\n"
            "  6c:	e5996004 	ldr	r6, [r9, #4]\n"
            "  70:	e5878028 	str	r8, [r7, #40]	@ 0x28\n"
            "  74:	e58ab008 	str	fp, [sl, #8]\n"
            "  78:	e12fff16 	bx	r6\n"
            "  7c:	e5996004 	ldr	r6, [r9, #4]\n"
            "  80:	e5878028 	str	r8, [r7, #40]	@ 0x28\n"
            "  84:	e58ab008 	str	fp, [sl, #8]\n"
            "  88:	e12fff16 	bx	r6"
        >>,
    ?assertStream(arm32, Dump, Stream).
