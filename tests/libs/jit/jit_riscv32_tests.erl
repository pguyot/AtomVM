...
call_ext_last_direct_test() ->
    ...
    Dump =
        <<"   0:	00092f83          	lw	t6,0(s2)\n   4:	048faf83          	lw	t6,72(t6)\n   8:	00cfaf03          	lw	t5,12(t6)\n   c:	000f2e83          	lw	t4,0(t5)\n  10:	ff9e8e13          	addi	t3,t4,-7\n  14:	020e1763          	bnez	t3,0x42\n  18:	000efe93          	andi	t4,t4,0\n  1c:	9f76                	add	t5,t5,t4\n  1e:	01d92223          	sw	t4,4(s2)\n  22:	008a2e03          	lw	t3,8(s4)\n  26:	07c4a823          	sw	t3,112(s1)\n  2a:	00ca2e03          	lw	t3,12(s4)\n  2e:	07c4aa23          	sw	t3,116(s1)\n  32:	0a41                	addi	s4,s4,16\n  34:	004f2e83          	lw	t4,4(t5)\n  38:	008f2f03          	lw	t5,8(t5)\n  3c:	01d92023          	sw	t4,0(s2)\n  40:	8f02                	jr	t5\n  42:	01c9af83          	lw	t6,28(s3)\n  46:	1141                	addi	sp,sp,-16\n  48:	c006                	sw	ra,0(sp)\n  4a:	4501                	li	a0,0\n  4c:	4585                	li	a1,1\n  4e:	460d                	li	a2,3\n  50:	4689                	li	a3,2\n  52:	0344a423          	sw	s4,40(s1)\n  56:	9f82                	jalr	t6\n  58:	8faa                	mv	t6,a0\n  5a:	4082                	lw	ra,0(sp)\n  5c:	0141                	addi	sp,sp,16\n  5e:	001fff13          	andi	t5,t6,1\n  62:	000f1463          	bnez	t5,0x6a\n  66:	857e                	mv	a0,t6\n  68:	8082                	ret\n  6a:	0284aa03          	lw	s4,40(s1)\n  6e:	ffefff93          	andi	t6,t6,-2\n  72:	8f82                	jr	t6">>,
    ?assertStream(riscv32, Dump, ?BACKEND:stream(State1)).
...
call_ext_only_direct_test() ->
    ...
    Dump =
        <<"   0:	00092f83          	lw	t6,0(s2)\n   4:	048faf83          	lw	t6,72(t6)\n   8:	00cfaf03          	lw	t5,12(t6)\n   c:	000f2e83          	lw	t4,0(t5)\n  10:	ff9e8e13          	addi	t3,t4,-7\n  14:	000e1e63          	bnez	t3,0x30\n  18:	000efe93          	andi	t4,t4,0\n  1c:	9f76                	add	t5,t5,t4\n  1e:	01d92223          	sw	t4,4(s2)\n  22:	004f2e83          	lw	t4,4(t5)\n  26:	008f2f03          	lw	t5,8(t5)\n  2a:	01d92023          	sw	t4,0(s2)\n  2e:	8f02                	jr	t5\n  30:	01c9af83          	lw	t6,28(s3)\n  34:	1141                	addi	sp,sp,-16\n  36:	c006                	sw	ra,0(sp)\n  38:	4501                	li	a0,0\n  3a:	4585                	li	a1,1\n  3c:	460d                	li	a2,3\n  3e:	56fd                	li	a3,-1\n  40:	0344a423          	sw	s4,40(s1)\n  44:	9f82                	jalr	t6\n  46:	8faa                	mv	t6,a0\n  48:	4082                	lw	ra,0(sp)\n  4a:	0141                	addi	sp,sp,16\n  4c:	001fff13          	andi	t5,t6,1\n  50:	000f1463          	bnez	t5,0x58\n  54:	857e                	mv	a0,t6\n  56:	8082                	ret\n  58:	0284aa03          	lw	s4,40(s1)\n  5c:	ffefff93          	andi	t6,t6,-2\n  60:	8f82                	jr	t6">>,
    ?assertStream(riscv32, Dump, ?BACKEND:stream(State1)).

call_ext_with_cp_direct_test() ->
    State0 = ?BACKEND:new(?JIT_VARIANT_PIC, jit_stream_binary, jit_stream_binary:new(0)),
    State1 = ?BACKEND:call_ext_with_cp_direct(State0, 7, 3, [ctx, jit_state, 0, 1, 3, -2]),
    Dump =
        <<"   0:	00092f83          	lw	t6,0(s2)\n   4:	07f4aa23          	sw	t6,116(s1)\n   8:	1f800f93          	li	t6,504\n   c:	00000013          	nop\n  10:	07f4a823          	sw	t6,112(s1)\n  14:	00092f83          	lw	t6,0(s2)\n  18:	048faf83          	lw	t6,72(t6)\n  1c:	00cfaf03          	lw	t5,12(t6)\n  20:	000f2e83          	lw	t4,0(t5)\n  24:	ff9e8e13          	addi	t3,t4,-7\n  28:	000e1e63          	bnez	t3,0x44\n  2c:	000efe93          	andi	t4,t4,0\n  30:	9f76                	add	t5,t5,t4\n  32:	01d92223          	sw	t4,4(s2)\n  36:	004f2e83          	lw	t4,4(t5)\n  3a:	008f2f03          	lw	t5,8(t5)\n  3e:	01d92023          	sw	t4,0(s2)\n  42:	8f02                	jr	t5\n  44:	01c9af83          	lw	t6,28(s3)\n  48:	1141                	addi	sp,sp,-16\n  4a:	c006                	sw	ra,0(sp)\n  4c:	4501                	li	a0,0\n  4e:	4585                	li	a1,1\n  50:	460d                	li	a2,3\n  52:	56f9                	li	a3,-2\n  54:	0344a423          	sw	s4,40(s1)\n  58:	9f82                	jalr	t6\n  5a:	8faa                	mv	t6,a0\n  5c:	4082                	lw	ra,0(sp)\n  5e:	0141                	addi	sp,sp,16\n  60:	001fff13          	andi	t5,t6,1\n  64:	000f1463          	bnez	t5,0x6c\n  68:	857e                	mv	a0,t6\n  6a:	8082                	ret\n  6c:	0284aa03          	lw	s4,40(s1)\n  70:	ffdf8f13          	addi	t5,t6,-3\n  74:	000f0563          	beqz	t5,0x7e\n  78:	ffefff93          	andi	t6,t6,-2\n  7c:	8f82                	jr	t6">>,
    ?assertStream(riscv32, Dump, ?BACKEND:stream(State1)).
...
call_fun_with_cp_direct_test() ->
    ...
    Dump =
        <<"   0:	02c4af83          	lw	t6,44(s1)\n   4:	00092f03          	lw	t5,0(s2)\n   8:	07e4aa23          	sw	t5,116(s1)\n   c:	12000f13          	li	t5,288\n  10:	00000013          	nop\n  14:	07e4a823          	sw	t5,112(s1)\n  18:	01c9af03          	lw	t5,28(s3)\n  1c:	1141                	addi	sp,sp,-16\n  1e:	c006                	sw	ra,0(sp)\n  20:	4501                	li	a0,0\n  22:	85fe                	mv	a1,t6\n  24:	4605                	li	a2,1\n  26:	0344a423          	sw	s4,40(s1)\n  2a:	9f02                	jalr	t5\n  2c:	8f2a                	mv	t5,a0\n  2e:	4082                	lw	ra,0(sp)\n  30:	0141                	addi	sp,sp,16\n  32:	001f7f93          	andi	t6,t5,1\n  36:	000f9463          	bnez	t6,0x3e\n  3a:	857a                	mv	a0,t5\n  3c:	8082                	ret\n  3e:	0284aa03          	lw	s4,40(s1)\n  42:	ffef7f13          	andi	t5,t5,-2\n  46:	8f02                	jr	t5">>,
    ...
    [
        ...
        {"move_array_element from index 1024 to a y register", fun() ->
            ...
            large_operand_dump(
                ...
                <<
                    ...
                    "   a:	000eae83          	lw	t4,0(t4) # 0x1000\n"
                    "   e:	01da2223          	sw	t4,4(s4)"
                >>
            )
        end},
        ...
        {"move_to_vm_register to a deep y register", fun() ->
            ...
            large_operand_dump(
                ...
                <<
                    "   0:	02c4af83          	lw	t6,44(s1)\n"
                    "   4:	32000f13          	li	t5,800\n"
                    "   8:	9f52                	add	t5,t5,s4\n"
                    "   a:	01ff2023          	sw	t6,0(t5)"
                >>
            )
        end},
        ...
        {"and_ with a mask needing a literal", fun() ->
            ...
            large_operand_dump(
                ...
                <<
                    "   0:	02c4af83          	lw	t6,44(s1)\n"
                    "   4:	6f49                	lui	t5,0x12\n"
                    "   6:	345f0f13          	addi	t5,t5,837 # 0x12345\n"
        ...
        {"mul by a constant needing a literal", fun() ->
            ...
            large_operand_dump(
                ...
                <<
                    "   0:	02c4af83          	lw	t6,44(s1)\n"
                    "   4:	6f0d                	lui	t5,0x3\n"
                    "   6:	039f0f13          	addi	t5,t5,57 # 0x3039\n"
        ...
        {"if_block on a large immediate", fun() ->
            ...
            large_operand_dump(
                ...
                <<
                    ...
                    "   8:	678f0f13          	addi	t5,t5,1656 # 0x12345678\n"
                    "   c:	01ef9563          	bne	t6,t5,0x16\n"
                    "  10:	4f01                	li	t5,0\n"
                    "  12:	03e4a823          	sw	t5,48(s1)"
                >>
            )
        end}
    ].
...
large_operand_dump(State, Dump) ->
    ?assertStream(riscv32, Dump, ?BACKEND:stream(?BACKEND:flush(State))).
