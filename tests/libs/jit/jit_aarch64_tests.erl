...
call_primitive_6_args_test() ->
    ...
    Dump =
        <<
            ...
            "  38:	a945eab9 	ldp	x25, x26, [x21, #88]\n"
            "  3c:	a946f2bb 	ldp	x27, x28, [x21, #104]"
        >>,
    ?assertStream(aarch64, Dump, Stream).
...
call_primitive_extended_regs_test() ->
    ...
    Dump =
        <<
            ...
            "  74:	a945eab9 	ldp	x25, x26, [x21, #88]\n"
            "  78:	a946f2bb 	ldp	x27, x28, [x21, #104]\n"
            "  7c:	f9000100 	str	x0, [x8]"
        >>,
    ?assertStream(aarch64, Dump, Stream).
...
call_bif_with_large_literal_integer_test() ->
    ...
    Dump =
        <<
            ...
            "  50:	aa0003f0 	mov	x16, x0\n"
            "  54:	aa1503e0 	mov	x0, x21\n"
            "  58:	d2800001 	mov	x1, #0x0\n"
            "  5c:	d2800022 	mov	x2, #0x1\n"
            "  60:	aa1903e3 	mov	x3, x25\n"
            "  64:	aa0703e4 	mov	x4, x7\n"
            "  68:	f9000eb6 	str	x22, [x21, #24]\n"
            "  6c:	f9002ab7 	str	x23, [x21, #80]\n"
            "  70:	d63f0200 	blr	x16\n"
            "  74:	f9401a7e 	ldr	x30, [x19, #48]\n"
            "  78:	f9400eb6 	ldr	x22, [x21, #24]\n"
            "  7c:	f9402ab7 	ldr	x23, [x21, #80]\n"
            "  80:	a945eab9 	ldp	x25, x26, [x21, #88]\n"
            "  84:	a946f2bb 	ldp	x27, x28, [x21, #104]\n"
            "  88:	b50000c0 	cbnz	x0, 0xa0\n"
            "  8c:	f9401a87 	ldr	x7, [x20, #48]\n"
            "  90:	d2801200 	mov	x0, #0x90\n"
            "  94:	f9000eb6 	str	x22, [x21, #24]\n"
            "  98:	f9002ab7 	str	x23, [x21, #80]\n"
            "  9c:	d61f00e0 	br	x7\n"
            "  a0:	aa0003f9 	mov	x25, x0\n"
            "  a4:	f9002ea0 	str	x0, [x21, #88]"
        >>,
    ?assertStream(aarch64, Dump, Stream).
...
wait_timeout_test() ->
    ...
    Dump = <<
        ...
        "  34:	d63f0200 	blr	x16\n"
        "  38:	f9401a7e 	ldr	x30, [x19, #48]\n"
        "  3c:	f9400eb6 	ldr	x22, [x21, #24]\n"
        "  40:	f9402ab7 	ldr	x23, [x21, #80]\n"
        "  44:	a945eab9 	ldp	x25, x26, [x21, #88]\n"
        "  48:	a946f2bb 	ldp	x27, x28, [x21, #104]\n"
        "  4c:	eb15001f 	cmp	x0, x21\n"
        "  50:	54000040 	b.eq	0x58\n"
        "  54:	d65f03c0 	ret\n"
        "  58:	f9408690 	ldr	x16, [x20, #264]\n"
