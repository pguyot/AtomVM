...
call_fun_test() ->
    ...
    Dump = <<
        ...
        "  2c:	92400509 	and	x9, x8, #0x3\n"
        "  30:	f100093f 	cmp	x9, #0x2\n"
        "  34:	54000120 	b.eq	0x58\n"
        "  38:	f9404e87 	ldr	x7, [x20, #152]\n"
        "  3c:	d2800780 	mov	x0, #0x3c\n"
        "  40:	d2803161 	mov	x1, #0x18b\n"
        "  44:	aa0803e2 	mov	x2, x8\n"
        "  48:	f9000eb6 	str	x22, [x21, #24]\n"
        "  4c:	f9002ab7 	str	x23, [x21, #80]\n"
        "  50:	b9001278 	str	w24, [x19, #16]\n"
        "  54:	d61f00e0 	br	x7\n"
        ...
        "  84:	b9001278 	str	w24, [x19, #16]\n"
        "  88:	d61f00e0 	br	x7\n"
        "  8c:	f9401668 	ldr	x8, [x19, #40]\n"
        "  90:	d2805c10 	mov	x16, #0x2e0\n"
        "  94:	aa100108 	orr	x8, x8, x16\n"
        "  98:	f90072a8 	str	x8, [x21, #224]\n"
        "  9c:	f9408288 	ldr	x8, [x20, #256]\n"
        "  a0:	aa0703e0 	mov	x0, x7\n"
        "  a4:	d2800001 	mov	x1, #0x0\n"
        "  a8:	f9000eb6 	str	x22, [x21, #24]\n"
        "  ac:	f9002ab7 	str	x23, [x21, #80]\n"
        "  b0:	b9001278 	str	w24, [x19, #16]\n"
        "  b4:	d61f0100 	br	x8"
    >>,
    ?assertStream(aarch64, Dump, Stream).
