...
call_primitive_2_args_test() ->
    ...
    Dump =
        <<
            ...
            "   8:	d2800561 	mov	x1, #0x2b\n"
            "   c:	d2800582 	mov	x2, #0x2c\n"
            "  10:	f9000eb6 	str	x22, [x21, #24]\n"
            "  14:	f9002ab7 	str	x23, [x21, #80]\n"
            "  18:	d63f0200 	blr	x16\n"
            "  1c:	f9401a7e 	ldr	x30, [x19, #48]\n"
            "  20:	f9400eb6 	ldr	x22, [x21, #24]\n"
            "  24:	f9402ab7 	ldr	x23, [x21, #80]\n"
            "  28:	a945eab9 	ldp	x25, x26, [x21, #88]\n"
            "  2c:	a946f2bb 	ldp	x27, x28, [x21, #104]"
        >>,
    ?assertStream(aarch64, Dump, Stream).
...
call_primitive_6_args_test() ->
    ...
    Dump =
        <<
            ...
            "   8:	aa1a03e8 	mov	x8, x26\n"
            "   c:	f940ba90 	ldr	x16, [x20, #368]\n"
            "  10:	aa0703e0 	mov	x0, x7\n"
            "  14:	d2800801 	mov	x1, #0x40\n"
            "  18:	d2800102 	mov	x2, #0x8\n"
            "  1c:	aa0803e3 	mov	x3, x8\n"
            "  20:	f9000eb6 	str	x22, [x21, #24]\n"
            "  24:	f9002ab7 	str	x23, [x21, #80]\n"
            "  28:	d63f0200 	blr	x16\n"
            "  2c:	f9401a7e 	ldr	x30, [x19, #48]\n"
...
if_block_overflow_set_test() ->
    ...
    Dump =
        <<
            ...
            "   4:	aa1a03e8 	mov	x8, x26\n"
            "   8:	ab0800e7 	adds	x7, x7, x8\n"
            "   c:	54000067 	b.vc	0x18\n"
            "  10:	aa0703fb 	mov	x27, x7\n"
            "  14:	f90036a7 	str	x7, [x21, #104]"
        >>,
    ?assertStream(aarch64, Dump, Stream).
...
call_primitive_extended_regs_test() ->
    ...
    Dump =
        <<
            ...
            "   4:	d2800260 	mov	x0, #0x13\n"
            "   8:	d63f0200 	blr	x16\n"
            "   c:	f9401a7e 	ldr	x30, [x19, #48]\n"
            "  10:	f9404a90 	ldr	x16, [x20, #144]\n"
            "  14:	f81f0fe0 	str	x0, [sp, #-16]!\n"
            "  18:	d2800280 	mov	x0, #0x14\n"
            "  1c:	d63f0200 	blr	x16\n"
            "  20:	f9401a7e 	ldr	x30, [x19, #48]\n"
            "  24:	aa0003e7 	mov	x7, x0\n"
            "  28:	f84107e0 	ldr	x0, [sp], #16\n"
            "  2c:	f9404a90 	ldr	x16, [x20, #144]\n"
            "  30:	a9bf03e7 	stp	x7, x0, [sp, #-16]!\n"
            "  34:	d2800260 	mov	x0, #0x13\n"
            "  38:	d63f0200 	blr	x16\n"
            "  3c:	f9401a7e 	ldr	x30, [x19, #48]\n"
            "  40:	aa0003e8 	mov	x8, x0\n"
            "  44:	a8c103e7 	ldp	x7, x0, [sp], #16\n"
            "  48:	f9403690 	ldr	x16, [x20, #104]\n"
            "  4c:	f81f0fe8 	str	x8, [sp, #-16]!\n"
            "  50:	f9400000 	ldr	x0, [x0]\n"
            "  54:	f94000e1 	ldr	x1, [x7]\n"
            "  58:	f9000eb6 	str	x22, [x21, #24]\n"
            "  5c:	f9002ab7 	str	x23, [x21, #80]\n"
            "  60:	d63f0200 	blr	x16\n"
            "  64:	f9401a7e 	ldr	x30, [x19, #48]\n"
            "  68:	f84107e8 	ldr	x8, [sp], #16\n"
...
call_primitive_few_free_regs_test() ->
    ...
    Dump = <<
        ...
        "  18:	a9bf23e7 	stp	x7, x8, [sp, #-16]!\n"
        "  1c:	f81f0fe9 	str	x9, [sp, #-16]!\n"
        ...
        "  3c:	d63f0200 	blr	x16\n"
        "  40:	f9401a7e 	ldr	x30, [x19, #48]\n"
        "  44:	f84107e9 	ldr	x9, [sp], #16\n"
        "  48:	a8c123e7 	ldp	x7, x8, [sp], #16\n"
        "  4c:	f9400eb6 	ldr	x22, [x21, #24]\n"
        "  50:	f9402ab7 	ldr	x23, [x21, #80]\n"
        "  54:	a945eab9 	ldp	x25, x26, [x21, #88]\n"
        "  58:	a946f2bb 	ldp	x27, x28, [x21, #104]"
    >>,
    ?assertStream(aarch64, Dump, Stream).
...
call_ext_only_test() ->
    ...
    Dump = <<
        "   0:	f1000718 	subs	x24, x24, #0x1\n"
        "   4:	54000101 	b.ne	0x24\n"
        "   8:	100000e7 	adr	x7, 0x24\n"
        "   c:	f9000667 	str	x7, [x19, #8]\n"
        "  10:	f9400a87 	ldr	x7, [x20, #16]\n"
        "  14:	f9000eb6 	str	x22, [x21, #24]\n"
        "  18:	f9002ab7 	str	x23, [x21, #80]\n"
        "  1c:	b9001278 	str	w24, [x19, #16]\n"
        "  20:	d61f00e0 	br	x7\n"
        "  24:	f9401287 	ldr	x7, [x20, #32]\n"
        "  28:	d2800040 	mov	x0, #0x2\n"
        "  2c:	aa0003e1 	mov	x1, x0\n"
        "  30:	92800002 	mov	x2, #0xffffffffffffffff\n"
        "  34:	f9000eb6 	str	x22, [x21, #24]\n"
        "  38:	f9002ab7 	str	x23, [x21, #80]\n"
        "  3c:	b9001278 	str	w24, [x19, #16]\n"
        "  40:	d61f00e0 	br	x7"
    >>,
    ?assertStream(aarch64, Dump, Stream).
...
move_imported_gcbif_to_native_register_test() ->
    ...
    Dump =
        <<
            ...
            "   c:	540000e0 	b.eq	0x28\n"
            "  10:	f9401e90 	ldr	x16, [x20, #56]\n"
            "  14:	d2800040 	mov	x0, #0x2\n"
            "  18:	d63f0200 	blr	x16\n"
            "  1c:	f9401a7e 	ldr	x30, [x19, #48]\n"
            "  20:	a945eab9 	ldp	x25, x26, [x21, #88]\n"
            "  24:	a946f2bb 	ldp	x27, x28, [x21, #104]\n"
            "  28:	f9400267 	ldr	x7, [x19]\n"
            "  2c:	f94048e7 	ldr	x7, [x7, #144]\n"
            "  30:	f94014e7 	ldr	x7, [x7, #40]\n"
            "  34:	f94004e7 	ldr	x7, [x7, #8]"
        >>,
    ?assertStream(aarch64, Dump, Stream).
...
call_primitive_last_if_block_preserves_cache_test() ->
    ...
    Dump = <<
        "   0:	d2800027 	mov	x7, #0x1\n"
        "   4:	aa1903e8 	mov	x8, x25\n"
        "   8:	b50000c7 	cbnz	x7, 0x20\n"
...
call_primitive_direct_reloads_after_early_out_test() ->
    ...
    Dump =
        <<
            ...
            "  18:	37000060 	tbnz	w0, #0, 0x24\n"
            "  1c:	aa0003e0 	mov	x0, x0\n"
            "  20:	d65f03c0 	ret\n"
            "  24:	f9400eb6 	ldr	x22, [x21, #24]\n"
            "  28:	f9402ab7 	ldr	x23, [x21, #80]\n"
            "  2c:	a945eab9 	ldp	x25, x26, [x21, #88]\n"
            "  30:	a946f2bb 	ldp	x27, x28, [x21, #104]\n"
                ...
                ?_test(begin
                    ...
                    Dump =
                        <<
                            ...
                            "  18:	eb1500ff 	cmp	x7, x21\n"
                            "  1c:	54000060 	b.eq	0x28\n"
                            "  20:	aa0703e0 	mov	x0, x7\n"
                            "  24:	d65f03c0 	ret\n"
                            "  28:	f9400eb6 	ldr	x22, [x21, #24]\n"
                            "  2c:	f9402ab7 	ldr	x23, [x21, #80]\n"
                            "  30:	a945eab9 	ldp	x25, x26, [x21, #88]\n"
                            "  34:	a946f2bb 	ldp	x27, x28, [x21, #104]"
                        >>,
                    ?assertStream(aarch64, Dump, Stream)
                end)
            ]
...
call_only_or_schedule_next_and_label_relocation_test() ->
    ...
    Dump =
        <<
            ...
            "   4:	14000002 	b	0xc\n"
            "   8:	1400000b 	b	0x34\n"
            "   c:	f1000718 	subs	x24, x24, #0x1\n"
            "  10:	54000121 	b.ne	0x34\n"
            "  14:	10000107 	adr	x7, 0x34\n"
            "  18:	914000e7 	add	x7, x7, #0x0, lsl #12\n"
            "  1c:	f9000667 	str	x7, [x19, #8]\n"
            "  20:	f9400a87 	ldr	x7, [x20, #16]\n"
            "  24:	f9000eb6 	str	x22, [x21, #24]\n"
            "  28:	f9002ab7 	str	x23, [x21, #80]\n"
            "  2c:	b9001278 	str	w24, [x19, #16]\n"
            "  30:	d61f00e0 	br	x7\n"
            "  34:	f9400287 	ldr	x7, [x20]\n"
            "  38:	f9000eb6 	str	x22, [x21, #24]\n"
            "  3c:	f9002ab7 	str	x23, [x21, #80]\n"
            "  40:	b9001278 	str	w24, [x19, #16]\n"
            "  44:	d61f00e0 	br	x7\n"
            "  48:	f9400687 	ldr	x7, [x20, #8]\n"
            "  4c:	f9000eb6 	str	x22, [x21, #24]\n"
            "  50:	f9002ab7 	str	x23, [x21, #80]\n"
            "  54:	b9001278 	str	w24, [x19, #16]\n"
            "  58:	d61f00e0 	br	x7"
        >>,
    ?assertStream(aarch64, Dump, Stream).
...
call_only_or_schedule_next_known_label_test() ->
    ...
    Dump =
        <<
            ...
            "  20:	f9000eb6 	str	x22, [x21, #24]\n"
            "  24:	f9002ab7 	str	x23, [x21, #80]\n"
            "  28:	b9001278 	str	w24, [x19, #16]\n"
            "  2c:	d61f00e0 	br	x7\n"
            "  30:	f9400287 	ldr	x7, [x20]\n"
            "  34:	f9000eb6 	str	x22, [x21, #24]\n"
            "  38:	f9002ab7 	str	x23, [x21, #80]\n"
            "  3c:	b9001278 	str	w24, [x19, #16]\n"
            "  40:	d61f00e0 	br	x7\n"
...
call_bif_with_large_literal_integer_test() ->
    ...
    Dump =
        <<
            ...
            "   4:	d2800040 	mov	x0, #0x2\n"
            "   8:	d63f0200 	blr	x16\n"
            "   c:	f9401a7e 	ldr	x30, [x19, #48]\n"
            "  10:	f9403e90 	ldr	x16, [x20, #120]\n"
            "  14:	f81f0fe0 	str	x0, [sp, #-16]!\n"
            "  18:	d29579a0 	mov	x0, #0xabcd\n"
            "  1c:	f2b7c040 	movk	x0, #0xbe02, lsl #16\n"
            "  20:	f2dfd740 	movk	x0, #0xfeba, lsl #32\n"
            "  24:	f2eff940 	movk	x0, #0x7fca, lsl #48\n"
            "  28:	f9000eb6 	str	x22, [x21, #24]\n"
            "  2c:	f9002ab7 	str	x23, [x21, #80]\n"
            "  30:	d63f0200 	blr	x16\n"
            "  34:	f9401a7e 	ldr	x30, [x19, #48]\n"
            "  38:	aa0003e7 	mov	x7, x0\n"
            "  3c:	f84107e0 	ldr	x0, [sp], #16\n"
            "  40:	f9400eb6 	ldr	x22, [x21, #24]\n"
            "  44:	f9402ab7 	ldr	x23, [x21, #80]\n"
            "  48:	aa0003f0 	mov	x16, x0\n"
            "  4c:	aa1503e0 	mov	x0, x21\n"
            "  50:	d2800001 	mov	x1, #0x0\n"
            "  54:	d2800022 	mov	x2, #0x1\n"
            "  58:	aa1903e3 	mov	x3, x25\n"
            "  5c:	aa0703e4 	mov	x4, x7\n"
            "  60:	f9000eb6 	str	x22, [x21, #24]\n"
            "  64:	f9002ab7 	str	x23, [x21, #80]\n"
            "  68:	d63f0200 	blr	x16\n"
            "  6c:	f9401a7e 	ldr	x30, [x19, #48]\n"
            "  70:	f9400eb6 	ldr	x22, [x21, #24]\n"
            "  74:	f9402ab7 	ldr	x23, [x21, #80]\n"
            "  78:	a945eab9 	ldp	x25, x26, [x21, #88]\n"
            "  7c:	a946f2bb 	ldp	x27, x28, [x21, #104]\n"
            "  80:	b50000e0 	cbnz	x0, 0x9c\n"
            "  84:	f9401a87 	ldr	x7, [x20, #48]\n"
            "  88:	d2801100 	mov	x0, #0x88\n"
            "  8c:	f9000eb6 	str	x22, [x21, #24]\n"
            "  90:	f9002ab7 	str	x23, [x21, #80]\n"
            "  94:	b9001278 	str	w24, [x19, #16]\n"
            "  98:	d61f00e0 	br	x7\n"
            "  9c:	aa0003f9 	mov	x25, x0\n"
            "  a0:	f9002ea0 	str	x0, [x21, #88]"
        >>,
    ?assertStream(aarch64, Dump, Stream).
...
is_integer_test() ->
    ...
    Dump = <<
        "   0:	14000001 	b	0x4\n"
        "   4:	1400004e 	b	0x13c\n"
        "   8:	aa1903e7 	mov	x7, x25\n"
        "   c:	92400ce8 	and	x8, x7, #0xf\n"
        "  10:	f1003d1f 	cmp	x8, #0xf\n"
        "  14:	54000140 	b.eq	0x3c\n"
        "  18:	36000047 	tbz	w7, #0, 0x20\n"
        "  1c:	14000048 	b	0x13c\n"
        "  20:	927ef4e7 	and	x7, x7, #0xfffffffffffffffc\n"
        "  24:	f94000e7 	ldr	x7, [x7]\n"
        "  28:	d2800770 	mov	x16, #0x3b\n"
        "  2c:	8a1000f0 	and	x16, x7, x16\n"
        "  30:	f100221f 	cmp	x16, #0x8\n"
        "  34:	54000040 	b.eq	0x3c\n"
        "  38:	14000041 	b	0x13c"
    >>,
    ?assertStream(aarch64, Dump, Stream).
...
is_number_test() ->
    ...
    Dump = <<
        ...
        "  34:	540000a0 	b.eq	0x48\n"
        "  38:	924014f0 	and	x16, x7, #0x3f\n"
        "  3c:	f100621f 	cmp	x16, #0x18\n"
        "  40:	54000040 	b.eq	0x48\n"
        "  44:	14000041 	b	0x148"
    >>,
    ?assertStream(aarch64, Dump, Stream).
...
wait_timeout_test() ->
    ...
    Dump = <<
        ...
        "  24:	b9001278 	str	w24, [x19, #16]\n"
        "  28:	d61f0100 	br	x8\n"
        "  2c:	f9405690 	ldr	x16, [x20, #168]\n"
        "  30:	f9000eb6 	str	x22, [x21, #24]\n"
        "  34:	f9002ab7 	str	x23, [x21, #80]\n"
        "  38:	d63f0200 	blr	x16\n"
        "  3c:	f9401a7e 	ldr	x30, [x19, #48]\n"
        "  40:	eb15001f 	cmp	x0, x21\n"
        ...
        "  64:	d63f0200 	blr	x16\n"
        "  68:	f9401a7e 	ldr	x30, [x19, #48]\n"
        "  6c:	b50000e0 	cbnz	x0, 0x88\n"
        "  70:	f9407e87 	ldr	x7, [x20, #248]\n"
        "  74:	d2800540 	mov	x0, #0x2a\n"
        "  78:	f9000eb6 	str	x22, [x21, #24]\n"
        "  7c:	f9002ab7 	str	x23, [x21, #80]\n"
        "  80:	b9001278 	str	w24, [x19, #16]\n"
        "  84:	d61f00e0 	br	x7"
    >>,
    ?assertStream(aarch64, Dump, Stream).
...
gc_bif2_test() ->
    ...
    Dump = <<
        ...
        "   8:	d63f0200 	blr	x16\n"
        "   c:	f9401a7e 	ldr	x30, [x19, #48]\n"
        "  10:	aa0003f0 	mov	x16, x0\n"
        "  14:	aa1503e0 	mov	x0, x21\n"
        "  18:	d2800001 	mov	x1, #0x0\n"
        "  1c:	d2800062 	mov	x2, #0x3\n"
        "  20:	f94002e3 	ldr	x3, [x23]\n"
        "  24:	aa1903e4 	mov	x4, x25\n"
        "  28:	f9000eb6 	str	x22, [x21, #24]\n"
        "  2c:	f9002ab7 	str	x23, [x21, #80]\n"
        "  30:	d63f0200 	blr	x16\n"
        "  34:	f9401a7e 	ldr	x30, [x19, #48]\n"
        "  38:	f9400eb6 	ldr	x22, [x21, #24]\n"
        "  3c:	f9402ab7 	ldr	x23, [x21, #80]\n"
...
memory_ensure_free_with_roots_test() ->
    ...
    Dump = <<
        ...
        "   8:	d2800081 	mov	x1, #0x4\n"
        "   c:	d2800022 	mov	x2, #0x1\n"
        "  10:	f9000eb6 	str	x22, [x21, #24]\n"
        "  14:	f9002ab7 	str	x23, [x21, #80]\n"
        "  18:	d63f0200 	blr	x16\n"
        "  1c:	f9401a7e 	ldr	x30, [x19, #48]\n"
...
call_ext_test() ->
    ...
    Dump = <<
        ...
        "  1c:	b9001278 	str	w24, [x19, #16]\n"
        "  20:	d61f00e0 	br	x7\n"
        "  24:	f9401667 	ldr	x7, [x19, #40]\n"
        "  28:	d2802a10 	mov	x16, #0x150\n"
        "  2c:	aa1000e7 	orr	x7, x7, x16\n"
        "  30:	f90072a7 	str	x7, [x21, #224]\n"
        "  34:	f9401287 	ldr	x7, [x20, #32]\n"
        "  38:	d2800040 	mov	x0, #0x2\n"
        "  3c:	d28000a1 	mov	x1, #0x5\n"
        "  40:	92800002 	mov	x2, #0xffffffffffffffff\n"
        "  44:	f9000eb6 	str	x22, [x21, #24]\n"
        "  48:	f9002ab7 	str	x23, [x21, #80]\n"
        "  4c:	b9001278 	str	w24, [x19, #16]\n"
        "  50:	d61f00e0 	br	x7"
    >>,
    ?assertStream(aarch64, Dump, Stream).
...
call_fun_test() ->
    ...
    Dump = <<
        ...
        "  1c:	b9001278 	str	w24, [x19, #16]\n"
        "  20:	d61f00e0 	br	x7\n"
        "  24:	aa1903e7 	mov	x7, x25\n"
        "  28:	aa0703e8 	mov	x8, x7\n"
        "  2c:	36000128 	tbz	w8, #0, 0x50\n"
        "  30:	f9404e87 	ldr	x7, [x20, #152]\n"
        "  34:	d2800680 	mov	x0, #0x34\n"
        "  38:	d2803161 	mov	x1, #0x18b\n"
        "  3c:	aa0803e2 	mov	x2, x8\n"
        "  40:	f9000eb6 	str	x22, [x21, #24]\n"
        "  44:	f9002ab7 	str	x23, [x21, #80]\n"
        "  48:	b9001278 	str	w24, [x19, #16]\n"
        "  4c:	d61f00e0 	br	x7\n"
        "  50:	927ef508 	and	x8, x8, #0xfffffffffffffffc\n"
        "  54:	f9400108 	ldr	x8, [x8]\n"
        "  58:	92401509 	and	x9, x8, #0x3f\n"
        "  5c:	f100513f 	cmp	x9, #0x14\n"
        "  60:	54000120 	b.eq	0x84\n"
        "  64:	f9404e87 	ldr	x7, [x20, #152]\n"
        "  68:	d2800d00 	mov	x0, #0x68\n"
        "  6c:	d2803161 	mov	x1, #0x18b\n"
        "  70:	aa0803e2 	mov	x2, x8\n"
        "  74:	f9000eb6 	str	x22, [x21, #24]\n"
        "  78:	f9002ab7 	str	x23, [x21, #80]\n"
        "  7c:	b9001278 	str	w24, [x19, #16]\n"
        "  80:	d61f00e0 	br	x7\n"
        "  84:	f9401668 	ldr	x8, [x19, #40]\n"
        "  88:	d2805810 	mov	x16, #0x2c0\n"
        "  8c:	aa100108 	orr	x8, x8, x16\n"
        "  90:	f90072a8 	str	x8, [x21, #224]\n"
        "  94:	f9408288 	ldr	x8, [x20, #256]\n"
        "  98:	aa0703e0 	mov	x0, x7\n"
        "  9c:	d2800001 	mov	x1, #0x0\n"
        "  a0:	f9000eb6 	str	x22, [x21, #24]\n"
        "  a4:	f9002ab7 	str	x23, [x21, #80]\n"
        "  a8:	b9001278 	str	w24, [x19, #16]\n"
        "  ac:	d61f0100 	br	x8"
    >>,
    ?assertStream(aarch64, Dump, Stream).
...
decrement_reductions_invalidates_cache_test() ->
    ...
    Dump = <<
        "   0:	aa1903e7 	mov	x7, x25\n"
        "   4:	f1000718 	subs	x24, x24, #0x1\n"
        "   8:	54000101 	b.ne	0x28\n"
        "   c:	100000e7 	adr	x7, 0x28\n"
        "  10:	f9000667 	str	x7, [x19, #8]\n"
        "  14:	f9400a87 	ldr	x7, [x20, #16]\n"
        "  18:	f9000eb6 	str	x22, [x21, #24]\n"
        "  1c:	f9002ab7 	str	x23, [x21, #80]\n"
        "  20:	b9001278 	str	w24, [x19, #16]\n"
        "  24:	d61f00e0 	br	x7\n"
        "  28:	aa1903e7 	mov	x7, x25"
    >>,
    ?assertStream(aarch64, Dump, Stream).
            ...
            [
                ...
                ?_test(begin
                    move_to_vm_register_test0(State0, r10, {x_reg, 0}, <<
                        "   0:	aa0a03f9 	mov	x25, x10\n"
                        "   4:	f9002eaa 	str	x10, [x21, #88]"
                    >>)
                end),
                ?_test(begin
            ...
            [
                ...
                ?_test(begin
                    ...
                    move_array_element_test0(State1, r8, {free, Reg}, {x_reg, 2}, <<
                        ...
                        "   8:	aa0703fb 	mov	x27, x7\n"
                        "   c:	f90036a7 	str	x7, [x21, #104]"
                    >>)
                end),
...
call_only_or_schedule_next_far_test() ->
    ...
    State5 = ?BACKEND:update_branches(State4),
    Stream = ?BACKEND:stream(State5),
    % After the jump table (3 * 4 bytes) and the pinned-register reduction
    % decrement (1 instruction: subs), at 16#10: b.eq +8; b 0x200000
    <<_:16#10/binary, Code:8/binary, _/binary>> = Stream,
    % b.eq 0x18 (skip over the b); b 0x200000 (Rel = 16#200000 - 16#14)
    ?assertEqual(
        <<
            16#54000040:32/little,
            (16#14000000 bor ((16#200000 - 16#14) div 4)):32/little
        >>,
        Code
    ).
