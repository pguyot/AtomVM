...
move_to_cp_test() ->
    ...
    Dump =
        <<
            ...
            "   2:	6837      	ldr	r7, [r6, #0]\n"
            "   4:	6707      	str	r7, [r0, #112]	@ 0x70\n"
            "   6:	6a86      	ldr	r6, [r0, #40]	@ 0x28\n"
            "   8:	6877      	ldr	r7, [r6, #4]\n"
            "   a:	6747      	str	r7, [r0, #116]	@ 0x74"
        >>,
    ?assertStream(arm, Dump, Stream).
...
%% A frame deallocation of 70 slots (280 bytes) no longer fits the 8-bit adds
%% immediate and must go through a second register.
increment_sp_large_test() ->
    State0 = ?BACKEND:new(?JIT_VARIANT_PIC, jit_stream_binary, jit_stream_binary:new(0)),
    State1 = ?BACKEND:increment_sp(State0, 70),
    Stream = ?BACKEND:stream(State1),
    Dump =
        <<
            "   0:	6a87      	ldr	r7, [r0, #40]\n"
...
call_only_or_schedule_next_and_label_relocation_large_gap_test() ->
    ...
    ?assertStream(arm, Dump, RelevantBinary).
...
call_ext_test() ->
    ...
    Dump = <<
        ...
        "  1e:	9e00      	ldr	r6, [sp, #0]\n"
        "  20:	6837      	ldr	r7, [r6, #0]\n"
        "  22:	6747      	str	r7, [r0, #116]	@ 0x74\n"
        "  24:	4f06      	ldr	r7, [pc, #24]	@ (0x40)\n"
        "  26:	6707      	str	r7, [r0, #112]	@ 0x70\n"
        ...
        "  42:	0000      	movs	r0, r0\n"
        "  44:	b5f2      	push	{r1, r4, r5, r6, r7, lr}"
    >>,
    ?assertStream(arm, Dump, Stream).
...
call_fun_test() ->
    ...
    Dump = <<
        ...
        "  64:	9d00      	ldr	r5, [sp, #0]\n"
        "  66:	682e      	ldr	r6, [r5, #0]\n"
        "  68:	6746      	str	r6, [r0, #116]	@ 0x74\n"
        "  6a:	4e05      	ldr	r6, [pc, #20]	@ (0x80)\n"
        "  6c:	6706      	str	r6, [r0, #112]	@ 0x70\n"
        ...
        "  82:	0000      	movs	r0, r0\n"
        "  84:	b5f2      	push	{r1, r4, r5, r6, r7, lr}"
    >>,
    ?assertStream(arm, Dump, Stream).
    ...
    {setup,
        ...
        fun(State0) ->
            [
                ...
                %% Test: y_reg index (64) whose byte offset (256) no longer
                %% fits the 8-bit movs immediate used to build it
                ?_test(begin
                    move_to_vm_register_test0(State0, 42, {y_reg, 64}, <<
                        "   0:	262a      	movs	r6, #42	; 0x2a\n"
                        "   2:	6a87      	ldr	r7, [r0, #40]\n"
                        "   4:	2501      	movs	r5, #1\n"
                        "   6:	022d      	lsls	r5, r5, #8\n"
                ...
                %% Test: y_reg index (300) whose byte offset (1200) is neither
                %% an 8-bit immediate nor a shifted byte
                ?_test(begin
                    move_to_vm_register_test0(State0, 42, {y_reg, 300}, <<
                        "   0:	262a      	movs	r6, #42	; 0x2a\n"
                        "   2:	6a87      	ldr	r7, [r0, #40]\n"
                        "   4:	2504      	movs	r5, #4\n"
                        "   6:	022d      	lsls	r5, r5, #8\n"
                        "   8:	35b0      	adds	r5, #176	; 0xb0\n"
                        "   a:	443d      	add	r5, r7\n"
                        "   c:	602e      	str	r6, [r5, #0]\n"
                        "   e:	e077      	b.n	0x100"
                    >>)
                end),
                %% Test: reading back a y_reg with a large byte offset
                ?_test(begin
                    move_to_vm_register_test0(State0, {y_reg, 64}, {x_reg, 0}, <<
                        "   0:	6a86      	ldr	r6, [r0, #40]\n"
                        "   2:	2701      	movs	r7, #1\n"
                        "   4:	023f      	lsls	r7, r7, #8\n"
                        "   6:	4437      	add	r7, r6\n"
...
and_register_exhaustion_negative_test() ->
    ...
    ExpectedDump = <<
        ...
        "  12:	4660      	mov	r0, ip"
    >>,
    ?assertStream(arm, ExpectedDump, Stream).
...
add_beam_test() ->
    ...
    Dump =
        <<
            ...
            "  32:	6307      	str	r7, [r0, #48]	@ 0x30\n"
            "  34:	278f      	movs	r7, #143	@ 0x8f\n"
            "  36:	62c7      	str	r7, [r0, #44]	@ 0x2c\n"
            "  38:	9e00      	ldr	r6, [sp, #0]\n"
            "  3a:	68b7      	ldr	r7, [r6, #8]\n"
            "  3c:	3f01      	subs	r7, #1\n"
            "  3e:	60b7      	str	r7, [r6, #8]\n"
            ...
            "  8e:	6a87      	ldr	r7, [r0, #40]	@ 0x28\n"
            "  90:	603e      	str	r6, [r7, #0]\n"
            "  92:	9e00      	ldr	r6, [sp, #0]\n"
            "  94:	6837      	ldr	r7, [r6, #0]\n"
            "  96:	6747      	str	r7, [r0, #116]	@ 0x74\n"
            "  98:	4f0b      	ldr	r7, [pc, #44]	@ (0xc8)\n"
            "  9a:	6707      	str	r7, [r0, #112]	@ 0x70\n"
            "  9c:	9e00      	ldr	r6, [sp, #0]\n"
            "  9e:	68b7      	ldr	r7, [r6, #8]\n"
            "  a0:	3f01      	subs	r7, #1\n"
            "  a2:	60b7      	str	r7, [r6, #8]\n"
...
jump_to_label_invalidates_cache_test() ->
    ...
    Dump =
        <<
            ...
            "   a:	ffff 6ac7 	vtbx.8	d22, {d31-<overflow reg d33}, d7"
        >>,
    ?assertStream(arm, Dump, Stream).
    ...
    [
        {"get_array_element at index 1024", fun() ->
            ...
            large_operand_dump(
                ...
                <<
                    "   0:	6ac7      	ldr	r7, [r0, #44]	@ 0x2c\n"
                    "   2:	4d01      	ldr	r5, [pc, #4]	@ (0x8)\n"
                    "   4:	443d      	add	r5, r7\n"
                    "   6:	6fee      	ldr	r6, [r5, #124]	@ 0x7c\n"
                    "   8:	0f84      	lsrs	r4, r0, #30\n"
                    "   a:	0000      	movs	r0, r0"
                >>
            )
        end},
        {"move_array_element from index 1024 to an x register", fun() ->
            ...
            large_operand_dump(
                ...
                <<
                    "   0:	6ac7      	ldr	r7, [r0, #44]	@ 0x2c\n"
                    "   2:	4e02      	ldr	r6, [pc, #8]	@ (0xc)\n"
                    "   4:	443e      	add	r6, r7\n"
                    "   6:	6ff5      	ldr	r5, [r6, #124]	@ 0x7c\n"
                    "   8:	6305      	str	r5, [r0, #48]	@ 0x30\n"
                    "   a:	0000      	movs	r0, r0\n"
        ...
        {"move_array_element from index 1024 to a y register", fun() ->
            ...
            large_operand_dump(
                ...
                <<
                    "   0:	6ac7      	ldr	r7, [r0, #44]	@ 0x2c\n"
                    "   2:	4d02      	ldr	r5, [pc, #8]	@ (0xc)\n"
                    "   4:	443d      	add	r5, r7\n"
                    "   6:	6fed      	ldr	r5, [r5, #124]	@ 0x7c\n"
        ...
        {"move_to_array_element at index 1024", fun() ->
            ...
            large_operand_dump(
                ...
                <<
                    "   0:	6ac7      	ldr	r7, [r0, #44]	@ 0x2c\n"
                    "   2:	6b06      	ldr	r6, [r0, #48]	@ 0x30\n"
                    "   4:	4d01      	ldr	r5, [pc, #4]	@ (0xc)\n"
                    "   6:	443d      	add	r5, r7\n"
                    "   8:	67ee      	str	r6, [r5, #124]	@ 0x7c\n"
                    "   a:	0000      	movs	r0, r0\n"
                    "   c:	0f84      	lsrs	r4, r0, #30\n"
                    "   e:	0000      	movs	r0, r0"
                >>
...
large_operand_dump(State, Dump) ->
    ?assertStream(arm, Dump, ?BACKEND:stream(?BACKEND:flush(State))).
