...
struct Test tests[] = {
    ...
    TEST_CASE(test_put_map_exact_shared_keys),
    TEST_CASE_ATOMVM_ONLY(test_update_record_inplace, 0),
    TEST_CASE(test_update_record_rebuild),
    ...
    TEST_CASE_EXPECTED(div_rem_pow2, 1078554),
    ...
    TEST_CASE(test_gc),
    TEST_CASE(test_minor_gc_messages),
