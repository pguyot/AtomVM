...
struct Test tests[] = {
    ...
    TEST_CASE(test_bs_1),
    TEST_CASE(test_bs_2),
    TEST_CASE(test_bs_3a1),
    TEST_CASE(test_bs_3a2),
    TEST_CASE(test_bs_3a3_a),
    TEST_CASE(test_bs_3a3_b),
    TEST_CASE(test_bs_3a3_c),
    TEST_CASE(test_bs_3a3_d),
    TEST_CASE(test_bs_3a3_e),
    TEST_CASE(test_bs_3a3),
    TEST_CASE(test_bs_3a4),
    TEST_CASE(test_bs_3a5),
