...
-define(SYSTEM_LIMIT_ATOM_INDEX, 21).
-define(EXTERNAL_ATOM_INDEX, 18).
...
-define(EXTERNAL_ATOM, ((?EXTERNAL_ATOM_INDEX bsl ?TERM_IMMED2_TAG_SIZE) bor ?TERM_IMMED2_ATOM)).
