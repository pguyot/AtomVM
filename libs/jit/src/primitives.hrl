...
-define(PRIM_TRY_CASE, 77).
-define(PRIM_BITSTRING_GET_TAIL_HEAP_SIZE, 78).
-define(PRIM_BITSTRING_CREATE_TAIL, 79).
-define(PRIM_BS_CREATE_BIN_WRAP, 80).
-define(PRIM_BITSTRING_SLICE_HEAP_SIZE, 81).
-define(PRIM_BITSTRING_SLICE, 82).
-define(PRIM_BITSTRING_IS_MULTIPLE_OF, 83).
-define(PRIM_RECORD_DEF_ARITY, 84).
-define(PRIM_RECORD_FIELD_POS, 85).
-define(PRIM_PUT_RECORD, 86).
-define(PRIM_IS_RECORD_OF, 87).
-define(PRIM_IS_RECORD_ACCESSIBLE, 88).
-define(PRIM_GET_RECORD_FIELD, 89).
-define(PRIM_PUT_RECORD_RESOLVED, 90).
-define(PRIM_GET_IMPORTED_GCBIF, 91).
-define(PRIM_SET_TUPLE_ELEMENT, 92).
-define(PRIM_PUT_MAP_HEAP_NEED, 93).
-define(PRIM_MAP_GET_VALUE, 94).
-define(PRIM_TERM_GET_MAP_ASSOC, 95).
-define(PRIM_TERM_GET_MAP_ASSOC_MISS, 96).
-define(PRIM_CALL_FUN_DIRECT, 97).
-define(PRIM_CALL_EXT_DIRECT, 98).
-define(PRIM_RETURN_DIRECT, 99).
-define(PRIM_PUT_MAP_ONE_HEAP_NEED, 100).
-define(PRIM_PUT_MAP_ASSOC_ONE, 101).
-define(PRIM_PUT_MAP_EXACT_ONE_HEAP_NEED, 102).
-define(PRIM_PUT_MAP_EXACT_ONE, 103).
-define(PRIM_TERM_REUSE_OR_CLONE_BINARY, 104).
-define(PRIM_RECV_MARKER_RESERVE, 105).
-define(PRIM_RECV_MARKER_USE, 106).
-define(PRIM_RECV_MARKER_CLEAR, 107).
-define(PRIM_REMOVE_MESSAGE_KEEP, 108).
-define(PRIM_FORWARD_MESSAGE, 109).
