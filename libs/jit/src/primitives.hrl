...
-define(PRIM_RECORD_DEF_ARITY, 77).
-define(PRIM_RECORD_FIELD_POS, 78).
-define(PRIM_PUT_RECORD, 79).
-define(PRIM_IS_RECORD_OF, 80).
-define(PRIM_IS_RECORD_ACCESSIBLE, 81).
-define(PRIM_GET_RECORD_FIELD, 82).
