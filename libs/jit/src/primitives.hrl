...
-define(PRIM_RECORD_DEF_ARITY, 78).
-define(PRIM_RECORD_FIELD_POS, 79).
-define(PRIM_PUT_RECORD, 80).
-define(PRIM_IS_RECORD_OF, 81).
-define(PRIM_IS_RECORD_ACCESSIBLE, 82).
-define(PRIM_GET_RECORD_FIELD, 83).
-define(PRIM_PUT_RECORD_RESOLVED, 84).
-define(PRIM_GET_IMPORTED_GCBIF, 85).
-define(PRIM_SET_TUPLE_ELEMENT, 86).
-define(PRIM_PUT_MAP_HEAP_NEED, 87).
-define(PRIM_MAP_GET_VALUE, 88).
-define(PRIM_TERM_GET_MAP_ASSOC, 89).
-define(PRIM_TERM_GET_MAP_ASSOC_MISS, 90).
-define(PRIM_CALL_FUN_DIRECT, 91).
-define(PRIM_CALL_EXT_DIRECT, 92).
-define(PRIM_RETURN_DIRECT, 93).
-define(PRIM_BITSTRING_GET_TAIL_HEAP_SIZE, 94).
-define(PRIM_BITSTRING_CREATE_TAIL, 95).
-define(PRIM_BS_CREATE_BIN_WRAP, 96).
-define(PRIM_BITSTRING_SLICE_HEAP_SIZE, 97).
-define(PRIM_BITSTRING_SLICE, 98).
-define(PRIM_BITSTRING_IS_MULTIPLE_OF, 99).
