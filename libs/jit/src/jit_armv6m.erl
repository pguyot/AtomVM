...
call_func_ptr(
    ...
    State1 = State0#state{
        available_regs = regs_to_mask(SetArgsPushStackAvailableArgs),
        used_regs = regs_to_mask(?AVAILABLE_REGS -- SetArgsPushStackAvailableArgs),
        stream = Stream1
    },
    State2 =
        case StackArgs of
...
set_registers_args(
    ...
    State1#state{
        stream = Stream1,
        available_regs = regs_to_mask(FinalAvail),
        used_regs = regs_to_mask(FinalUsed)
    }.
