...
-define(HEAP_ROOT_OFFSET, 16#8).
-define(HEAP_END_OFFSET, 16#20).
-define(SHRINK_PROBE_OFFSET, 16#1A0).
...
-define(MODULE_IMPORTED_FUNCS_OFFSET, 16#90).
-define(MODULE_FUNCTION_TYPE_OFFSET, 0).
-define(MODULE_FUNCTION_TARGET_OFFSET, 16#8).
-define(MODULE_FUNCTION_ENTRY_POINT_OFFSET, 16#10).
