...
div_reg(
    ...
    I = jit_riscv64_asm:'div'(DividendReg, DividendReg, DivisorReg),
    Stream1 = StreamModule:append(Stream0, I),
...
rem_reg(
    ...
    I = jit_riscv64_asm:'rem'(DividendReg, DividendReg, DivisorReg),
    Stream1 = StreamModule:append(Stream0, I),
    Regs1 = jit_regs:invalidate_reg(Regs0, DividendReg),
    {State#state{stream = Stream1, regs = Regs1}, DividendReg}.
