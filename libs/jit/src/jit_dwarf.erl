...
generate_debug_info_section_with_opcodes(
    ...
    FunctionDIEs = generate_function_dies_with_module(
        Functions, ModuleName, State, ContextPtrTypeOffset, HighPC
    ),
...
generate_function_dies_with_module(
    Functions, ModuleName, #dwarf{backend = Backend}, ContextPtrTypeOffset, CodeSize
) ->
    ...
    FunctionDIEsList = [
        generate_function_die_with_module(
...
generate_function_die_with_module(
    Offset, FunctionName, Arity, FunctionSize, ModuleName, Backend, ContextPtrTypeOffset
) ->
...
create_section_headers_proper(
    ...
    NullHeaderSize = SectionHeaderSizeBits div 8,
