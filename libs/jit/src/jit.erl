...
op_gc_bif2(
    ...
    op_gc_bif2_add(MMod, MSt0, FailLabel, Live, Bif, Arg1, Arg2, Dest, Range1, Range2);
% + with literal Arg1 and typed Arg2 (commutative, swap operands)
op_gc_bif2(
    MMod, MSt0, FailLabel, Live, Bif, erlang, '+', Arg1, {typed, Arg2, {t_integer, Range2}}, Dest
) when is_integer(Arg1), Arg1 band ?TERM_IMMED_TAG_MASK =:= ?TERM_INTEGER_TAG ->
    Arg1Value = Arg1 bsr 4,
    Range1 = {Arg1Value, Arg1Value},
    op_gc_bif2_add(MMod, MSt0, FailLabel, Live, Bif, Arg2, Arg1, Dest, Range2, Range1);
op_gc_bif2(
    MMod,
    MSt0,
    FailLabel,
...
op_gc_bif2(
    ...
    Range2 = {Arg2Value, Arg2Value},
    op_gc_bif2_band(MMod, MSt0, FailLabel, Live, Bif, Arg1, Arg2, Dest, Range1, Range2);
% band - literal Arg1 with typed Arg2 (commutative, swap operands)
op_gc_bif2(
    MMod,
    MSt0,
    FailLabel,
    ...
    Arg1Value = Arg1 bsr 4,
    Range1 = {Arg1Value, Arg1Value},
    op_gc_bif2_band(MMod, MSt0, FailLabel, Live, Bif, Arg2, Arg1, Dest, Range2, Range1);
...
op_gc_bif2(
    ...
    Range2 = {Arg2Value, Arg2Value},
    op_gc_bif2_bor(MMod, MSt0, FailLabel, Live, Bif, Arg1, Arg2, Dest, Range1, Range2);
% bor - literal Arg1 with typed Arg2 (commutative, swap operands)
op_gc_bif2(
    MMod,
    MSt0,
    FailLabel,
    ...
    Arg1Value = Arg1 bsr 4,
    Range1 = {Arg1Value, Arg1Value},
    op_gc_bif2_bor(MMod, MSt0, FailLabel, Live, Bif, Arg2, Arg1, Dest, Range2, Range1);
...
op_gc_bif2(
    ...
    Range2 = {Arg2Value, Arg2Value},
    op_gc_bif2_bxor(MMod, MSt0, FailLabel, Live, Bif, Arg1, Arg2, Dest, Range1, Range2);
% bxor - literal Arg1 with typed Arg2 (commutative, swap operands)
op_gc_bif2(
    MMod,
    MSt0,
    FailLabel,
    ...
    Arg1Value = Arg1 bsr 4,
    Range1 = {Arg1Value, Arg1Value},
    op_gc_bif2_bxor(MMod, MSt0, FailLabel, Live, Bif, Arg2, Arg1, Dest, Range2, Range1);
% Default case
op_gc_bif2(
